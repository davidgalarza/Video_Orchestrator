...
Desktop: 224px navigation, flexible preview/storyboard, 344px scene inspector. Below 1100px, navigation collapses; on mobile, preview, scene selector and inspector stack in workflow order. Settings are a page, not a modal. Visible focus, labelled controls, reduced-motion support, meaningful empty states and inline recovery actions are required.
